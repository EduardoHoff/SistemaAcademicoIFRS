...
class Pessoa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nome, dataNascimento, cpf, matricula, tipo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblUsers' => array(self::HAS_MANY, 'TblUser', 'id_pessoa'),
			'turmas' => array(self::HAS_MANY, 'Turma', 'id_pessoa'),
		);
	}
