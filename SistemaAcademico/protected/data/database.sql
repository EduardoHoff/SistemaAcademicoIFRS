...
insert into turma (id_disciplina, id_pessoa, nome, dataInicio, dataFinal, periodo) values (1, 1, "ADS.2014.1.ProgramacaoI", "2014-02-20", "2014-07-01", "2014/1");
insert into turma (id_disciplina, id_pessoa, nome, dataInicio, dataFinal, periodo) values (2, 2, "ADS.2014.1.GerenciaDeProjetos", "2014-02-20", "2014-07-01", "2014/1");